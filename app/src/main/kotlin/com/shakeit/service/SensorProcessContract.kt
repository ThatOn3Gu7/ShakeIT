...
object SensorProcessContract {
    ...
    const val EXTRA_ACCELEROMETER_NAME = "accelerometer_name"
    const val EXTRA_ACCELEROMETER_TYPE = "accelerometer_type"
    const val EXTRA_ACCELEROMETER_REPORTING_MODE = "accelerometer_reporting_mode"
